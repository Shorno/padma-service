...
export default function RocketVerificationCard({order}: RocketVerificationCardProps) {
                ...
                <div className={`${config.color} text-white rounded-lg p-6 space-y-4`}>
                    ...
                    <div className="space-y-3 pt-2">
                        ...
                        <ol className="space-y-2.5 text-sm list-decimal list-inside marker:font-bold">
                            <li className="pl-2">
                                Dial <span className="font-bold">{config.dialCode}</span> or open the Rocket App
                            </li>
                            ...
                            <li className="pl-2">
                                Enter your Rocket Mobile Menu PIN to confirm
                            </li>
                            ...
                            <li className="pl-2">
                                Paste your <span className="font-bold text-yellow-300">Rocket Number</span> and{" "}
